document.addEventListener('DOMContentLoaded', function() {
  ...
  <div class="container">
  <a class="navbar-brand" href="index.html"><img src="integrantes/img/logo/logo.png" alt="" id="logo_home" width="70" height="50"></a>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (footerElement !== null) {
      footerElement.innerHTML = `<section id="copyright_section">
        <p>&copy; TRAVEL 360</p>
      </section>`;
    }
  });})